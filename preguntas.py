...
def pregunta_01():
    ...
    df = pd.read_csv(
        "C:\\Users\\danii\\Documents\\GitHub\\analisis-de-sentimientos-amazon-danielvillam\\amazon_cells_labelled.tsv",
        sep="\t",
        header=None,
        names=['msg','lbl'],
    )
...
def pregunta_03():
    ...
    analyzer = CountVectorizer().toarray()
...
if __name__ == "__main__":
    ...
    print(x_tagged.shape == (1000,))
    print(y_tagged.shape == (1000,))
    print(x_untagged.shape == (13609,))
    print(y_untagged.shape == (13609,))